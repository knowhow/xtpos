...
BEGIN  
  ...
  ELSE
    ...
    SELECT rtlsite_asset_accnt_id AS reghist_asset_accnt_id, 
      ...
      warehous_id, warehous_taxauth_id, 
      taxauth_curr_id, terminal_number INTO _rec
    FROM xtpos.rtlsiteterm
      ...
      LEFT OUTER JOIN taxauth ON (warehous_taxauth_id=taxauth_id)
